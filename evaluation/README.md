...
- `_utils.py`: shared metric and plotting helpers used by notebooks and the report runner.
...
- `test_evaluate.py`, `test_utils.py`: regression tests for evaluation behavior.
